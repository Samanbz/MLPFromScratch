...
TEST_CASE("MLP construction with initial weights", "[MLP]") {
    ...
    REQUIRE(mlp.get_layers().size() == 1);  // 2 layers (hidden and output)
...
TEST_CASE("MLP end to end", "[MLP]") {
    ...
    REQUIRE(layers[0].get_neurons()[0].get_weights()[0] == 0.1);
    REQUIRE(layers[0].get_neurons()[1].get_weights()[0] == 0.3);
    REQUIRE(layers[1].get_neurons()[0].get_weights()[0] == 0.4);
    REQUIRE(layers[1].get_neurons()[0].get_weights()[1] == 0.2);
    ...
    REQUIRE(layers[0].get_neurons()[0].get_pre_activation() == 0.1);
    REQUIRE(layers[0].get_neurons()[1].get_pre_activation() == 0.3);
    REQUIRE_THAT(layers[0].get_neurons()[0].get_output(), WithinAbs(0.5249, 1e-4));
    REQUIRE_THAT(layers[0].get_neurons()[1].get_output(), WithinAbs(0.5744, 1e-4));

    REQUIRE_THAT(layers[1].get_neurons()[0].get_pre_activation(), WithinAbs(0.3248, 1e-4));
    REQUIRE_THAT(layers[1].get_neurons()[0].get_output(), WithinAbs(0.5805, 1e-4));
    ...
    REQUIRE_THAT(layers.back().get_neurons()[0].get_weight_gradient()[0], WithinAbs(0.0205, 1e-4));
    REQUIRE_THAT(layers.back().get_neurons()[0].get_weight_gradient()[1], WithinAbs(0.0225, 1e-4));

    REQUIRE_THAT(layers[0].get_gradient()[0], WithinAbs(0.0039, 1e-4));
    REQUIRE_THAT(layers[0].get_gradient()[1], WithinAbs(0.0019, 1e-4));
    REQUIRE_THAT(layers[0].get_neurons()[0].get_weight_gradient()[0], WithinAbs(0.0039, 1e-4));
    REQUIRE_THAT(layers[0].get_neurons()[1].get_weight_gradient()[0], WithinAbs(0.0019, 1e-4));
}
